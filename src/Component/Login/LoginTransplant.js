...
export default function LoginTransplant() {
  const auth = getAuth();
  ...
  return (
    <div className="flex flex-col items-center justify-center pt-12">
      ...
      <h1 className="text-xl font-bold mb-7">Transplant Coordinator Login</h1>
      <form className="flex flex-col w-96" onSubmit={handleLogin}>
        ...
        <input
          ...
          className="text-center h-12 my-5 rounded-3xl border-2 outline-none"
        />
        <p className="text-red-500 italic text-center mb-3">
          {pwd.length < 8 && pwdFocus && "Password must be 8 characters long"}
        </p>
